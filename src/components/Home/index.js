    ...
    <div className={styles.container}>
      <div className={styles.photo}>
        <div className={styles.modalContent}>
          <div className={styles.title}>Happy birthday Brandon!</div>
          <div className={styles.message}>
            2020 isn’t what any of us thought it would be, and though we can’t celebrate with you in person, we wanted
            to show you how much you mean to us. Here are some thoughts your friends throught the years wanted to share
