    ...
    return (
      <div className={styles.intro}>
        <div className={styles.introParagraph}>
          ...
          train that does not stop for anybody. That is how I like to live - always moving and penetrating any obstacle
          in my path, like Bo Joon-Ho’s Snowpiercer. It is with this hard mentality, partially inspired by Goggins, that
          I achieved unthinkable accomplishments, including (but not limited to):
          <ul>
            <li>
              President of the Maine East HS Spanish Club (which inspired my wild adventures abroad in Spain involving a
              garage in Barcelona)
            </li>
            <li>
        ...
        <div className={styles.introParagraph}>
          And I leave you with this pondering thought that I ask myself every morning when I wake up at 1pm - “Why do we
          fall?”
        </div>
      </div>
    );
